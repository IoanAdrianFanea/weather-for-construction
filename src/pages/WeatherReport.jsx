...
const wetBulb = (tempC, humidity) => { // Calculate wet bulb temperature in °C using the Stull approximation
...
const Card = ({ label, value, unit, sub, highlight, children }) => ( // A component for displaying individual weather parameters
...
const WideCard = ({ label, value, unit, sub, badge, badgeColor }) => ( // A wider component for displaying more important parameters 
...
const Grid = ({ children }) => ( // A simple grid layout component
