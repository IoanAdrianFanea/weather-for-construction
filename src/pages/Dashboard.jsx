...
/* FETCH BACKGROUND GIF BASED ON WEATHER CONDITIONS */
...
export const Dashboard = ({ current, forecast, loading, error, tempUnit = 'C', speedUnit = 'kmh', setActiveTab }) => {
  /* STATE TO HOLD SAFETY RECOMMENDATIONS */
  const [recommend, setRecommend] = useState([]); 

  /* EXTRACT ACTIVE WEATHER DATA FOR RECOMMENDATIONS */
  const activeCurrent = current; 

  /* EXTRACT KEY WEATHER DATA FOR RECOMMENDATIONS */
  const activeWeather = { 
  ...
  /* USE EFFECT TO GENERATE RECOMMENDATIONS WHEN WEATHER DATA CHANGES */
  useEffect(() => {
  ...
  /* EXTRACT RAW WEATHER DATA FOR CONVERSION */
  ...
  /* GENERATE ALERTS BASED ON WEATHER DATA AND PREDEFINED RULES */
  ...
  /* DETERMINE BACKGROUND GIF BASED ON CURRENT WEATHER CONDITIONS */
...
/* RENDER DASHBOARD COMPONENT WITH WEATHER DATA, ALERTS, AND RECOMMENDATIONS */
return (
  <div>
    {/* WEATHER BACKGROUND */}
    <div
